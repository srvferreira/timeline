...
function gerarTaxaDep(v)
{
	...
	document.getElementById('tabCadbens:txDeprec').value = taxa
	   //$('[id="tabCadbens:txDeprec"]').val((taxa).toFixed(2)); 
...
function somarCampos()
{
	...
	parseFloat(fatura) + parseFloat(origem) + parseFloat(doacao) + parseFloat(transferencia) + parseFloat(justo) - parseFloat(residual);
